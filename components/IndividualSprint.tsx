...
const SprintPage = ({
  ...
  return (
    <div className="w-full flex flex-col items-center p-8">
          ...
          <table className="w-50 flex flex-col justify-start">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="text-lg text-black">
                  <span
                    className={`px-3 py-1 text-lg font-semibold rounded-md ${
      ...
      <PopUp isOpen={burndownOpen} setIsOpen={setBurndownOpen}>
        <BurndownChart sprintData={sprintData} tasks={sprintData.tasks} />
      </PopUp>
    </div>
  );
};
