...
const ThemeSelector: React.FC<ThemeSelectorProps> = ({ setIsOpen, onThemeChange }) => {
  ...
  return (
    <div className="w-full max-w-3xl bg-white rounded-lg shadow-lg overflow-hidden">
      ...
      <div className="flex justify-end items-center p-4 border-t bg-gray-50">
        <button onClick={() => setIsOpen(false)} className="px-4 py-2 text-gray-600 hover:text-gray-800 font-medium mr-2">
          Cancel
        </button>
        <button 
          onClick={handleSave} 
