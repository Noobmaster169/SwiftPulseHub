...
const KanbanBoard: React.FC<KanbanBoardProps> = ({ tasks }) => {
  ...
  return (
    <div className="mt-6 grid grid-cols-3 gap-4 w-full">
      ...
      <div className="bg-blue-100 p-4 rounded-md drop w-52">
      ...
      <div className="bg-yellow-100 p-4 rounded-md drop w-52">
      ...
      <div className="bg-green-100 p-4 rounded-md drop w-52">
